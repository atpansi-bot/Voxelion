...
public sealed class LocalizationManager
{
    ...
    private static Dictionary<string, string> En() => new()
    {
        ...
        ["lang.name.ko"] = "Korean",
        ["settings.cat.graphics"] = "GRAPHICS",
        ["settings.cat.audio"] = "AUDIO",
        ["settings.cat.controls"] = "CONTROLS",
        ...
        ["settings.ui_scale"] = "UI SCALE {0}%",
        ["settings.network_on"] = "NETWORK ON",
        ["settings.network_off"] = "OFFLINE",
    ...
    private static Dictionary<string, string> Id() => new()
    {
        ...
        ["lang.name.id"] = "Bahasa Indonesia",
        ["lang.name.ja"] = "Jepang",
        ["lang.name.zh"] = "Tionghoa",
        ["lang.name.ko"] = "Korea",
        ["settings.cat.graphics"] = "GRAFIS",
        ["settings.cat.audio"] = "AUDIO",
        ["settings.cat.controls"] = "KONTROL",
        ["settings.cat.interface"] = "ANTARMUKA",
        ["settings.cat.accessibility"] = "AKSESIBILITAS",
        ["settings.cat.language"] = "BAHASA",
        ["settings.cat.notifications"] = "NOTIFIKASI",
        ["settings.cat.network"] = "JARINGAN",
        ["settings.cat.privacy"] = "PRIVASI",
        ["settings.cat.account"] = "AKUN",
        ["settings.ui_scale"] = "SKALA UI {0}%",
        ["settings.network_on"] = "JARINGAN ON",
        ["settings.network_off"] = "OFFLINE",
    ...
    private static Dictionary<string, string> Ja() => new()
    {
        ...
        ["lang.name.en"] = "英語",
        ["lang.name.id"] = "インドネシア語",
        ["lang.name.ja"] = "日本語",
        ["lang.name.zh"] = "中国語",
        ["lang.name.ko"] = "韓国語",
        ["settings.cat.graphics"] = "グラフィック",
        ["settings.cat.audio"] = "オーディオ",
        ["settings.cat.controls"] = "操作",
        ["settings.cat.interface"] = "インターフェース",
        ["settings.cat.accessibility"] = "アクセシビリティ",
        ["settings.cat.language"] = "言語",
        ["settings.cat.notifications"] = "通知",
        ["settings.cat.network"] = "ネットワーク",
        ["settings.cat.privacy"] = "プライバシー",
        ["settings.cat.account"] = "アカウント",
        ["settings.ui_scale"] = "UIスケール {0}%",
        ["settings.network_on"] = "ネットワークON",
        ["settings.network_off"] = "オフライン",
        ["lang.changed"] = "言語 {0}",
    };
    ...
    private static Dictionary<string, string> Zh() => new()
    {
        ...
        ["lang.name.zh"] = "中文",
        ["lang.name.ko"] = "韩语",
        ["settings.cat.graphics"] = "图形",
        ["settings.cat.audio"] = "音频",
        ["settings.cat.controls"] = "控制",
        ["settings.cat.interface"] = "界面",
        ["settings.cat.accessibility"] = "无障碍",
        ["settings.cat.language"] = "语言",
        ["settings.cat.notifications"] = "通知",
        ["settings.cat.network"] = "网络",
        ["settings.cat.privacy"] = "隐私",
        ["settings.cat.account"] = "账户",
        ["settings.ui_scale"] = "界面缩放 {0}%",
        ["settings.network_on"] = "网络开启",
        ["settings.network_off"] = "离线",
        ["lang.changed"] = "语言 {0}",
    };
    ...
    private static Dictionary<string, string> Ko() => new()
    {
        ...
        ["lang.name.zh"] = "중국어",
        ["lang.name.ko"] = "한국어",
        ["settings.cat.graphics"] = "그래픽",
        ["settings.cat.audio"] = "오디오",
        ["settings.cat.controls"] = "조작",
        ["settings.cat.interface"] = "인터페이스",
        ["settings.cat.accessibility"] = "접근성",
        ["settings.cat.language"] = "언어",
        ["settings.cat.notifications"] = "알림",
        ["settings.cat.network"] = "네트워크",
        ["settings.cat.privacy"] = "개인정보",
        ["settings.cat.account"] = "계정",
        ["settings.ui_scale"] = "UI 배율 {0}%",
        ["settings.network_on"] = "네트워크 켜짐",
        ["settings.network_off"] = "오프라인",
        ["lang.changed"] = "언어 {0}",
    };
}
